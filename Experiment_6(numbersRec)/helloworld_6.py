...
def test(path):
    ...
    with tf.Session() as sess:
        ...
        for i in range(0, len(label)):
            feed_dict = {input_x: features[i].reshape(1, 20, 80), keep_prob: 1.0}
