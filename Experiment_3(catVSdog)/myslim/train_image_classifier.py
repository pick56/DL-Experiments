...
if __name__ == '__main__':
  ...
  FLAGS.train_dir = 'dogsVScats/train_dir'
  FLAGS.dataset_name = 'dogsVScats'
  FLAGS.dataset_split_name='train'
  FLAGS.dataset_dir= 'dogsVScats/data'
  FLAGS.model_name= 'inception_v3'
  FLAGS.checkpoint_path= 'dogsVScats/pretrained/inception_v3.ckpt'
  ...
  FLAGS.save_interval_secs=300
  FLAGS.save_summaries_secs=2
